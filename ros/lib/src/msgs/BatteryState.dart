...
// Updated: Sun Jan  7 12:50:40 2024
...
class BatteryState extends RosMessage<BatteryState> {
  ...
  void serialize(ByteDataWriter writer) {
    ...
    writer.writeArray<double>(cell_temperature, (val) => writer.writeFloat32(val), specArrayLen: null);
  ...
  BatteryState deserialize(ByteDataReader reader) {
    ...
    data.cell_temperature = reader.readArray<double>(() => reader.readFloat32(), arrayLen: null);
