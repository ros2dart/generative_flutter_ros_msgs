...
// Updated: Sun Jan  7 12:52:19 2024
...
class SetCameraInfoRequest extends RosMessage<SetCameraInfoRequest> {
  ...
  void serialize(ByteDataWriter writer) {
    ...
    camera_info.serialize(writer);
  }

  @override
  SetCameraInfoRequest deserialize(ByteDataReader reader) {
    //deserializes a message object of type SetCameraInfoRequest
    final data = SetCameraInfoRequest();
    // Deserialize message field [camera_info]
    data.camera_info = CameraInfo.$prototype.deserialize(reader);
    return data;
  }
...
class SetCameraInfoResponse extends RosMessage<SetCameraInfoResponse> {
  ...
  void serialize(ByteDataWriter writer) {
    ...
    writer.writeString(status_message);
  }

  @override
  SetCameraInfoResponse deserialize(ByteDataReader reader) {
    //deserializes a message object of type SetCameraInfoResponse
    final data = SetCameraInfoResponse();
    // Deserialize message field [success]
    data.success = reader.readUint8() != 0;
    // Deserialize message field [status_message]
    data.status_message = reader.readString();
    return data;
  }
...
class SetCameraInfo extends RosServiceMessage<SetCameraInfoRequest, SetCameraInfoResponse> {
  static final $prototype = SetCameraInfo();
  @override
  SetCameraInfoRequest get request => SetCameraInfoRequest.$prototype;
  @override
  SetCameraInfoResponse get response => SetCameraInfoResponse.$prototype;
  @override
