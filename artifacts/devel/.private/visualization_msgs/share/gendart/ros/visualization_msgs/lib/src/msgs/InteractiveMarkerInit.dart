...
class InteractiveMarkerInit extends RosMessage<InteractiveMarkerInit> {
  String server_id;
  ...
  @override
  InteractiveMarkerInit deserialize(ByteDataReader reader) {
    //deserializes a message object of type InteractiveMarkerInit
    final data = InteractiveMarkerInit();
