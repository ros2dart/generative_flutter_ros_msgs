...
set(MSG_I_FLAGS "-Istereo_msgs:/catkin_ws/src/common_msgs/stereo_msgs/msg;-Isensor_msgs:/catkin_ws/src/common_msgs/sensor_msgs/msg;-Istd_msgs:/opt/ros/noetic/share/std_msgs/cmake/../msg;-Igeometry_msgs:/catkin_ws/src/common_msgs/geometry_msgs/msg")
...
add_custom_target(_stereo_msgs_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "stereo_msgs" "/catkin_ws/src/common_msgs/stereo_msgs/msg/DisparityImage.msg" "sensor_msgs/RegionOfInterest:std_msgs/Header:sensor_msgs/Image"
)
...
_generate_msg_cpp(stereo_msgs
  ...
  "${MSG_I_FLAGS}"
  "/catkin_ws/src/common_msgs/sensor_msgs/msg/RegionOfInterest.msg;/opt/ros/noetic/share/std_msgs/cmake/../msg/Header.msg;/catkin_ws/src/common_msgs/sensor_msgs/msg/Image.msg"
...
### Generating Module File
_generate_module_dart(stereo_msgs
  ${CATKIN_DEVEL_PREFIX}/${gendart_INSTALL_DIR}/stereo_msgs
  "${ALL_GEN_OUTPUT_FILES_dart}"
)

add_custom_target(stereo_msgs_generate_messages_dart
  DEPENDS ${ALL_GEN_OUTPUT_FILES_dart}
)
add_dependencies(stereo_msgs_generate_messages stereo_msgs_generate_messages_dart)

# add dependencies to all check dependencies targets
get_filename_component(_filename "/catkin_ws/src/common_msgs/stereo_msgs/msg/DisparityImage.msg" NAME_WE)
add_dependencies(stereo_msgs_generate_messages_dart _stereo_msgs_generate_messages_check_deps_${_filename})

# target for backward compatibility
add_custom_target(stereo_msgs_gendart)
add_dependencies(stereo_msgs_gendart stereo_msgs_generate_messages_dart)

# register target for catkin_package(EXPORTED_TARGETS)
list(APPEND ${PROJECT_NAME}_EXPORTED_TARGETS stereo_msgs_generate_messages_dart)
...
if(gendart_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${gendart_INSTALL_DIR}/stereo_msgs)
  # install generated code
  install(
    DIRECTORY ${CATKIN_DEVEL_PREFIX}/${gendart_INSTALL_DIR}/stereo_msgs
    DESTINATION ${gendart_INSTALL_DIR}
  )
endif()
if(TARGET sensor_msgs_generate_messages_dart)
  add_dependencies(stereo_msgs_generate_messages_dart sensor_msgs_generate_messages_dart)
endif()
if(TARGET std_msgs_generate_messages_dart)
  add_dependencies(stereo_msgs_generate_messages_dart std_msgs_generate_messages_dart)
endif()
